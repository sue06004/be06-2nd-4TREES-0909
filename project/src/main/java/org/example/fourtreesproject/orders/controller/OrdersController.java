...
public class OrdersController {
    ...
    @GetMapping("/page")
    public BaseResponse<OrderPageResponse> getOrderPageInfo(@AuthenticationPrincipal CustomUserDetails customUserDetails, Long gpbuyIdx, Integer quantity, Long bidIdx) throws RuntimeException {
        OrderPageResponse orderPageResponse = ordersService.loadOrderPage(customUserDetails.getIdx(), gpbuyIdx, quantity,bidIdx);
